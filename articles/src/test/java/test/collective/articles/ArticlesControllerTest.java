...
public class ArticlesControllerTest {
    private ArticleDataGateway gateway = new ArticleDataGateway(List.of(
            ...
            new ArticleRecord(10102, "Single Page Applications and ASP.NET Core 3.0", false),
            ...
            new ArticleRecord(10106, "Ryan Kitchens on Learning from Incidents at Netflix", true)
    ));
